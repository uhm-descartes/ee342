...
3. We set up _QuickSort_ in the last module. Please review the setup.
	...
	subsequence.
	  ...
	  4. This question anticipates a future topic, but what is the _joint_ distribution of $$L_1$$ and $$L_2$$? We have not formally defined the joint distribution yet, but this problem helps you appreciate the need for one.   
